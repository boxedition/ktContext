...
class GestureRecognizerHelper(
    ...
    fun setupGestureRecognizer() {
        ...
        try {
            ...
            gestureRecognizerListener?.onErrorGesture(
    ...
    private fun returnLivestreamResult(
        ...
        gestureRecognizerListener?.onResultsGesture(
            ResultBundle(
    ...
    interface GestureRecognizerListener {
        fun onErrorGesture(error: String, errorCode: Int = OTHER_ERROR)
        fun onResultsGesture(resultBundle: ResultBundle)
    }
}
